...
| Archived by the runs in this repo | 161 (649 files copied, 67 diagrams) |
| **Remaining** | **175** — list 07 `On Hold` (44 of 219 done) |
...
round-trip. All 161 are rendered locally under `data/cardmd/`; run
...
Every other part of those 161 cards — folder tree, copied files, diagrams —
is already in Drive.
