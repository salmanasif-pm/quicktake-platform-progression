...
DEST_MAPS = ["list04_dest_folders.json", "list05_dest_folders.json",
             ...
             "list06b_dest_folders.json", "list06c_dest_folders.json", "list06d_dest_folders.json", "list06e_dest_folders.json", "list07a_dest_folders.json", "list07b_dest_folders.json", "list07c_dest_folders.json", "list07d_dest_folders.json", "list07e_dest_folders.json", "list07f_dest_folders.json"]
